      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="relative h-8 w-8">
                <div className="absolute h-full w-full bg-primary rounded-full opacity-20"></div>
                <div className="absolute inset-1 bg-primary rounded-full"></div>
              </div>
              <span className="font-bold text-xl">DeployFlow</span>
            </Link>
            <p className="text-sm text-muted-foreground mb-4">
              Deploy your web applications with ease and speed. Get started today.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm text-muted-foreground hover:text-foreground">GDPR</Link></li>
        ...
        <div className="mt-12 pt-8 border-t text-center sm:flex sm:justify-between sm:text-left">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} DeployFlow. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground mt-4 sm:mt-0">
            Designed with 💙 for developers worldwide
          </p>
        </div>
      </div>
    </footer>
